...
$nombreusucomp = $_SESSION["nomemp"];
$nombreusuoent = $_SESSION["Usuario"];
$rolusu = $_SESSION["rol"];
$idusucomp = $_SESSION["idusu"];
?> 
<!DOCTYPE html>
<html lang="en">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Perfil de <?php echo $nombreusu ?></h1>
              ...
              <form action="modificar.php" method="post" enctype="multipart/form-data" class="user">
                <div class="form-row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" class="form-control" id="nombrecomp" name="nombrecomp" value="<?php echo $nombreusucomp ?>" readonly=""/>
                  </div>

                  <div class="form-group col-md-6">
                    <label for="telefono">Usuario: <?php echo $idusucomp ?></label>
                    <input type="text" class="form-control" id="usuariocomp" name="usuariocomp" value="<?php echo $nombreusuoent ?>" readonly=""/>
                  </div>
                </div>
                <div class="form-row ">
                  <div class="form-group col-md-6">
                    <label for="identidad">Rol</label>
                    <input type="text" class="form-control" id="rolcomp" name="rolcomp" value="<?php echo $rolusu ?>" readonly=""/>
                  </div>
                </div>
                <div class="form-group">
                  <label for="direccion">Contraseña nueva </label>
                  <input type="text" class="form-control" id="contrascomp" name="contrascomp" required="" pattern="^(?=(?:.*\d){1})(?=(?:.*[A-Z]){1})(?=(?:.*[a-z]){1})\S{8,}$" 
                  title="La contraseña debe contener al menos 8 dígitos, una letra mayúscula, una minúscula y uno número."/>
                </div>
                <button type="submit" class="btn btn-primary" name="perfil">Guardar</button>
              </form>
            </div>
          </div>
        </div>
