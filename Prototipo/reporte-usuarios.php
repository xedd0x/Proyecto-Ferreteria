      ...
      ?>
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="reporte-usuarios.php">Reportes de usuarios</a>
                  ...
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <tr>
                        ...
                        $consulta = "SELECT usuarios.id_usuario,nombre_usuario,contrasena,tipo_rol,descripcion, empleados.nombre_empleado,empleados.numero_identidad,empleados.direccion 
                      FROM usuarios
                      ...
                      ON usuarios.id_usuario = empleados.id_usuario;";
                        ...
                        if ($result = $conn->query($consulta)) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            $mosnumero_identidad = $row['numero_identidad'];
