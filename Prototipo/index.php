                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $consulta3 = "select count(*) from proveedores";
                                            if ($result3 = $conn3->query($consulta3)) {
                                                while ($row = $result3->fetch_assoc()) {
                                                    $conteo = $row['count(*)'];
                                            ?>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $conteo ?></div>
                                            <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include 'conexion/conexion.php';
                                            #preparamos la consulta a realizar, mediante la funcion inner join llamaremos los campos cargo y jornada laboral de sus respectivas tablas
                                            $consulta3 = "select count(*) from facturas_venta";
                                            $total_venta = 0;
                                            if ($result3 = $conn3->query($consulta3)) {
                                                while ($row = $result3->fetch_assoc()) {
                                                    $total_venta =$row['count(*)'];
                                                }
                                            ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $total_venta ?></div>
                                            <?php
                                            }
                                            ?>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include 'conexion/conexion.php';
                                            #preparamos la consulta a realizar, mediante la funcion inner join llamaremos los campos cargo y jornada laboral de sus respectivas tablas
                                            $consulta3 = "select count(*) from envios where estado = 0";
                                            if ($result3 = $conn3->query($consulta3)) {
                                                while ($row = $result3->fetch_assoc()) {
                                                    $conteo = $row['count(*)'];
                                            ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            include 'conexion/conexion.php';
                                            #preparamos la consulta a realizar, mediante la funcion inner join llamaremos los campos cargo y jornada laboral de sus respectivas tablas
                                            $consulta3 = "select count(*) from productos";
                                            if ($result3 = $conn3->query($consulta3)) {
                                                while ($row = $result3->fetch_assoc()) {
                                                    $conteo = $row['count(*)'];
                                            ?>
