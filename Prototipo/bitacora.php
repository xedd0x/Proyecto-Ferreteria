      ...
      ?>
        ...
        <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="bitacora.php">Bitácora</a>
          </div>
        </div>
      </li>
      <?php
                  ...
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <tr>
                        ...
                        $consulta = "SELECT id_bitacora,accion,fecha,hora,empleados.nombre_empleado
                        FROM bitacora
                        inner join usuarios
                        inner join empleados
                        where usuarios.id_usuario=bitacora.id_usuario and usuarios.id_usuario=empleados.id_usuario ;";
                        ...
                        if ($result = $conn->query($consulta)) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            $fecha = $row['fecha'];
                            $latinfechan = date("d/m/Y", strtotime($fecha));
