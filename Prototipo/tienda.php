    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
                      ...
                      <a class="dropdown-item d-flex align-items-center" href="#">
                        ...
                        <form action="eliminar.php" method="post">
                          ...
                          <div class="dropdown-list-image mr-7 d-flex flex-row-reverse ml-auto p-2">
                            <button type="submit" name="delete_prodcoticatacli" class="btn btn-danger btn-circle btn-sm"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash3" viewBox="0 0 16 16">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Catalogo de productos</h1>
          <div>
            <form method="post" action="factura-cliente.php">
              <button type="submit" class="btn btn-primary" name="agregarcclie">Terminar comprar</button>
            </form>
          </div>
                    ...
                    <div class="card" style="width: 11rem">
                      ...
                      <div class="card-body s">
                        ...
                        ?>
                          ...
                          <br>
                          <button type="submit" class="btn btn-primary" name="agregarcclie">Agregar al carrito</button>
