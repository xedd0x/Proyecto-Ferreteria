      ...
      ?>
        ...
        <li class="nav-item active">
          ...
          <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item " href="reporte-ventas.php">Reportes de ventas</a>
              <a class="collapse-item active" href="reporte-ventas-online.php">Reportes compra en linea</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Compras Clientes</h1>
                  ...
                  <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                      <tr>
                        ...
                        $consulta = "SELECT id_factura,fecha_factura,rtn,subtotal,descuento,impuesto, facturas_venta.total,facturas_venta.id_cotizacion,clientes.nombre_cliente,cotizaciones.codigo
                        FROM facturas_venta
                        inner join usuarios
                        inner join clientes
                        ...
                        if ($result = $conn->query($consulta)) {
                          ...
                          while ($row = $result->fetch_assoc()) {
                            ...
                            $nombre_empleado = $row['nombre_cliente'];
                            $codigo = $row['codigo'];
